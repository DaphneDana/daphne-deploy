...
const SectionCard: React.FC<{
  ...
  >
    <div 
      className="relative h-full p-6 sm:p-8 rounded-2xl shadow-xl transition-all duration-500 group-hover:shadow-2xl group-hover:-translate-y-2 overflow-hidden"
      style={{
      ...
      <div className="relative z-10">
        <div className="flex items-center mb-6">
          <div className="relative">
            ...
            <div className="relative p-3 bg-gradient-to-br from-blue-500/20 to-blue-600/30 rounded-full border border-blue-500/30 backdrop-blur-sm">
              <Icon size={24} className="text-blue-400 group-hover:text-blue-300 transition-colors duration-300" />
            </div>
          </div>
          <h3 className="text-xl sm:text-2xl font-semibold text-white ml-4 group-hover:text-blue-100 transition-colors duration-300">
            {title}
          </h3>
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="container-mx relative z-10">
        ...
        >
          <div className="inline-flex items-center px-4 py-2 mb-6 bg-blue-500/10 border border-blue-500/20 rounded-full backdrop-blur-sm">
            <Target size={16} className="text-blue-400 mr-2" />
            <span className="text-sm text-blue-300 font-medium">About Our Company</span>
          </div>
          ...
          <SectionCard title="Core Differentiators" icon={Zap} index={2}>
            <ul className="space-y-3">
              {overview.coreDifferentiators.map((item, index) => (
                ...
                >
                  <div className="flex-shrink-0 w-2 h-2 bg-blue-400 rounded-full mt-2.5 mr-3 group-hover/item:bg-blue-300 transition-colors duration-200" />
                  <span className="text-base sm:text-lg leading-relaxed group-hover/item:text-white transition-colors duration-200">
                    {item}
                  </span>
                </motion.li>
              ))}
